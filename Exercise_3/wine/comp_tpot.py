...
from utils import load_dataset_red, setup_logging
from sklearn.metrics import root_mean_squared_error, make_scorer


logger = setup_logging("comp_tpot")

X, y = load_dataset_red()
...
tpot = TPOTRegressor(generations=20, cv=rkf, population_size=100, verbosity=2, random_state=42, max_time_mins=90, config_dict=tpot_config, scoring=custom_score, template='Regressor', n_jobs=-1)
tpot.fit(X, y)
