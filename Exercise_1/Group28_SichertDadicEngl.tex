...
dimension reduction. Still for the LinearSVC classifier we used the QuantileTransformer, because the Power Transfomer is not parallelizable and therefore takes too much time to be viable.
...
\hline
LinearSVC & 0.963 & 0.956 & 0.750 & 0.723 & 0.853 & 0.659 & 0.747 & 0.734 \\
\hline
