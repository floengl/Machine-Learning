...
on the first glance. The results from ”Amazon Commerce Reviews” and ”Census Income” might suggest,
...
datasets, where n > d, which was especially noticeable for the ”Census Income” dataset. Also on the dual 
dataset as it is very low dimensional the dual formulation is faster. The results are shown in table~\ref{tab:dual_comparison}.
