...
{\color{red} Bitte auf Whatsapp schaun wegen svc vs lsvc vllt auch bisl auf mathemat hintegründe eingehen -> hab was du in deiner Audio erwähnt hast angeschnitten (in rot im Text), aber würd mit dir noch gern besprechen was du mit den math hintergründen meinst dass ich da noch nen satz dazu schreib vlt}
...
{\color{red} anmerken welche F1 score und wie der funktioniert haben eh alle getestet siehe whatsapp oder logfiles von test lsvc svc Man kann f1 macro auch auf nicht multiclass classification anwenden. und auch normalen f1 auf multiclass classification.}
