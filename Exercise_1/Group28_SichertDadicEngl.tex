...
highly depend on the split chosen as seen in figures~\ref{fig:model_comparison congress}
 and~\ref{fig:model_comparison amazon}, where the box-plots are shown for the
datasets \textit{'congressional voting'} and \textit{'Amazon Commerce Reviews'}.

\begin{figure}[h!]
\centering
\includegraphics[width=\textwidth]{congress/plots/model_comparison.pdf}
\caption{Model Comparison for \textit{'Congressional Voting'} dataset}
\label{fig:model_comparison congress}
\end{figure}
...
\hline
& \textbf{Train Time (s)} & \textbf{Pred Time (s)} & \textbf{Train Time (s)} & \textbf{Pred Time (s)} & \textbf{Train Time (s)} & \textbf{Pred Time (s)} & \textbf{Train Time (s)} & \textbf{Pred Time (s)} \\
\hline
LinearSVC & 0.174524 & 0.018444 & 0.511283 & 0.021711 & 0.003864 & 0.001623 & 0.002617 & 0.000600 \\
\hline
Ridge & 0.092652 & 0.022379 & 7.912478 & 0.199596 & 0.004253 & 0.001394 & 0.002666 & 0.000626 \\
\hline
RandomForest & 126.585000 & 1.630719 & 12.922183 & 0.097901 & 0.996177 & 0.028010 & 4.791669 & 0.088513 \\
\hline
\end{tabular}
\vspace{0.3cm}
