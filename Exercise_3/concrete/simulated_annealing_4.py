...
def simulate_annealing(start_params, param_vals, X, Y,  models, train_model=train_model_2, maxiters=100, alpha=0.95, beta=1.3, T_0=400, update_iters=5, f=5, n_repeats=1, random_seed=42,maxtime=120,mintime=60, go_to_best_multiple=5):
    ...
    for i in range(maxiters):
        ...
        if time.time() - start_time > maxtime*60:
            break
