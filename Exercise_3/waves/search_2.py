...
from utils import load_dataset_P_100, setup_logging
...
logger = setup_logging("search_P_100_2")
...
results_file = os.path.join(results_dir, f"results_P_100_{timestamp}.csv")
